...
这是 NailMind 的总仓库，用来集中放项目说明、方案文档和仓库导航。

业务代码已经拆分到三个独立仓库，并新增独立 GPU 推理模块（未启用）。根仓库主要作为公开展示入口和模块导航。
...
- [运营&商家web](http://121.40.171.199:8080/admin)
- [用户端apk下载](http://121.40.171.199:8080/downloads/NailMind.apk)
